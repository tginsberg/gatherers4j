...
| [`movingMax(window)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmax/)                                                            | Create a `Stream<T>` that represents the moving maximum value of a `Stream<T>`, looking back `window` number of elements, where `T` implements `Comparable<T>`.  |
| [`movingMaxBy(window, comparator)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmaxby/)                                            | Create a `Stream<T>` that represents the moving maximum value of a `Stream<T>`, looking back `window` number of elements, according to the given `comparator`.   |
...
| [`movingMin(window)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmin/)                                                            | Create a `Stream<T>` that represents the moving minimum value of a `Stream<T>`, looking back `window` number of elements, where `T` implements `Comparable<T>`.  |
| [`movingMinBy(window, comparator)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingminby/)                                            | Create a `Stream<T>` that represents the moving minimum value of a `Stream<T>`, looking back `window` number of elements, according to the given `comparator`.   |
...
| [`runningMax()`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmax/)                                                                | Create a `Stream<T>` that represents the running maximum value of a `Stream<T>`, where `T` implements `Comparable<T>`.                                           |
| [`runningMaxBy(comparator)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmaxby/)                                                  | Create a `Stream<T>` that represents the running maximum value of a `Stream<T>`, according to the given `comparator`.                                            |
...
| [`runningMin()`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmin/)                                                                | Create a `Stream<T>` that represents the running minimum value of a `Stream<T>`, where `T` implements `Comparable<T>`.                                           |
| [`runningMinBy(comparator)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningminby/)                                                  | Create a `Stream<T>` that represents the running minimum value of a `Stream<T>`, according to the given `comparator`.                                            |
