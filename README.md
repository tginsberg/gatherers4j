...
| [`runningMedianBy(fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmedianby/)                                                    | Create a `Stream<BigDecimal>` that represents the running mediation of `BigDecimal` objects mapped from a `Stream<INPUT>` via a `fn`.                            |
