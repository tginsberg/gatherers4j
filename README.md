...
```groovy
implementation("com.ginsberg:gatherers4j:0.15.0")
```
...
| [`sampleFixedSize(n)`](https://tginsberg.github.io/gatherers4j/gatherers/filtering-and-selection/samplefixedsize/)                 | Perform a fixed size sampling over the input stream, optionally taking a `RandomGenerator`.                                    |
| [`samplePercentage(d)`](https://tginsberg.github.io/gatherers4j/gatherers/filtering-and-selection/samplepercentage/)               | Perform a percentage-based sampling over the input stream, optionally taking a `RandomGenerator`.                              |                                                                                                                               | 
...
| [`movingMean(window)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmean/) | Create a moving mean of `BigDecimal` values over the previous `window` values. || [`movingMeanBy(window, fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmeanby/) | Create a moving mean of `BigDecimal` values over the previous `window` values, as mapped via `fn`. |
| [`movingMeanBy(window, fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingmeanby/) | Create a moving mean of `BigDecimal` values over the previous `window` values, as mapped via `fn`. |
...
| [`movingStandardDeviation(dataset, window)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingstandarddeviation/)                       | Create a moving standard deviation of `BigDecimal` objects over the previous `window` values, as either a population or a sample.                                |
| [`movingStandardDeviationBy(dataset, window, fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/movingstandarddeviationby/)               | Create a moving standard deviation of `BigDecimal` objects over the previous `window` values, as mapped via `fn`, as either a population or a sample.            |
...
| [`runningMean()`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmean/) | Create a running mean of `BigDecimal` values. || [`runningMeanBy(fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmeanby/) | Create a running mean of `BigDecimal` values as mapped via `fn`. |
| [`runningMeanBy(fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningmeanby/) | Create a running mean of `BigDecimal` values as mapped via `fn`. |
...
| [`runningStandardDeviation(dataset)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningstandarddeviation/)                             | Create a stream of `BigDecimal` objects representing the running standard deviation, as either a population or a sample.                                         |
| [`runningStandardDeviationBy(dataset, fn)`](https://tginsberg.github.io/gatherers4j/gatherers/mathematical/runningstandarddeviationby/)                     | Create a stream of `BigDecimal` objects as mapped from the input via `fn`, representing the running standard deviation, as either a population or a sample.      |
