...
This implementation is suitable for `Stream<BigDecimal>`, for a version that takes a user-specified mapping function see [`runningMedianBy()`](/gatherers4j/gatherers/mathematical/runningmedianby/).
