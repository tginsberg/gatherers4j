...
public sealed class FilterChangingComparatorGatherer<INPUT>
        implements Gatherer<INPUT, FilterChangingComparatorGatherer.State<INPUT>, INPUT>
        permits FilterChangingComparableGatherer {

    private final ChangingOperation operation;
    private final Comparator<INPUT> comparator;

    FilterChangingComparatorGatherer(
    ...
    @Override
    public Supplier<FilterChangingComparatorGatherer.State<INPUT>> initializer() {
        return State::new;
    }

    @Override
    public Integrator<FilterChangingComparatorGatherer.State<INPUT>, INPUT, INPUT> integrator() {
