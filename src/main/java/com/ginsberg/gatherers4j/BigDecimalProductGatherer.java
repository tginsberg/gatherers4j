...
public class BigDecimalProductGatherer<INPUT> extends BigDecimalGatherer<INPUT> {

    BigDecimalProductGatherer(final Function<INPUT, BigDecimal> mappingFunction) {
